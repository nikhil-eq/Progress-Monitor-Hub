...
st.set_page_config(page_title="Progress Monitor Hub", layout="wide")
...
st.logo("https://github.com/nikhil-eq/comprehensive-project-management/blob/main/eq%20-%20white.png?raw=true", size = 'large', )
